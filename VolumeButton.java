...
public class VolumeButton extends PauseButton {
	...
	private void loadImgs() {
		...
		for (int i = 0; i < imgs.length; i++)
			imgs[i] = temp.getSubimage(i * Def_VWidth, 0, Def_VWidth, Def_VHeight);

		slider = temp.getSubimage(3 * Def_VWidth, 0, Def_SliderWidth, Def_VHeight);
